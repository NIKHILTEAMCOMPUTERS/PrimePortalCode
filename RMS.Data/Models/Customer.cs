...
public partial class Customer
{
    ...
    public virtual ICollection<ProjectOld> ProjectOldCustomers { get; set; } = new List<ProjectOld>();

    public virtual ICollection<ProjectOld> ProjectOldProjectmodels { get; set; } = new List<ProjectOld>();

    public virtual ICollection<ProjectOld> ProjectOldProjecttypes { get; set; } = new List<ProjectOld>();

    public virtual ICollection<ProjectOld> ProjectOldSubpractises { get; set; } = new List<ProjectOld>();
